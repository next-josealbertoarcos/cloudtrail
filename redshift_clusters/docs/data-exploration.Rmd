...
```{r}
file <- read_json("../../data/2017/07/21/405540905874_CloudTrail_eu-west-1_20170721T0000Z_toFMCcKusnum4iUt.json")
str(file)
```
...
```{r}
file <- read_json("../../data/2017/04/22/405540905874_CloudTrail_eu-west-1_20170422T0000Z_EdBbEouphu5PwnGH.json")
data <- file[[1]]
datalist <- map(data, ~ as.data.frame(as.list(unlist(.))))
df <- rbind.fill(datalist)
View(df)
...
```{r}
json_files <- list.files(path = "../../data/2017/07/21/", full.names = TRUE)
